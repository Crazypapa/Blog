...
<pre>public class TimeDecoder extends ByteToMessageDecoder { // (1)
  @Override
...
<pre>b.handler(new ChannelInitializer<SocketChannel>() {
  @Override
...
<pre>public class TimeDecoder extends ReplayingDecoder<Void> {
  @Override
